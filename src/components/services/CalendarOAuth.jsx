...
export default function CalendarOAuth({ open, onOpenChange, onConnect }) {
    const [selectedScopes, setSelectedScopes] = useState(['read'])

    const scopes = [
        { id: 'read', label: 'Read Calendar', description: 'View your calendar events' },
        { id: 'write', label: 'Manage Events', description: 'Create and delete calendar events' }
    ]
